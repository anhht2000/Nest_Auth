...
export class initial1637031594111 implements MigrationInterface {
    name = 'initial1637031594111'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`photo\` CHANGE \`path\` \`pathL\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`photo\` DROP FOREIGN KEY \`FK_4494006ff358f754d07df5ccc87\``);
        await queryRunner.query(`ALTER TABLE \`photo\` DROP COLUMN \`pathL\``);
        await queryRunner.query(`ALTER TABLE \`photo\` ADD \`pathL\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`photo\` ADD \`pathL\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`photo\` ADD CONSTRAINT \`FK_4494006ff358f754d07df5ccc87\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`photo\` CHANGE \`pathL\` \`path\` varchar(255) NOT NULL`);
    }
