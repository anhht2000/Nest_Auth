...
export class initial1637033703633 implements MigrationInterface {
    name = 'initial1637033703633'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`name\` \`nameT\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`nameT\``);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`nameT\` varchar(255) NOT NULL`);
